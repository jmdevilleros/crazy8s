...
class Crazy8s(CardGame):
    ...
    def initialize(self):
        ...
        for player in self.players:
            ...
            function = self.selectcard
            player.data = [hand, function]
    ...
    def playturn(self):
        ...
        elected = self.current_player.data[1](candidates)
        if elected != None:
            # Play the card
            elected.flip()
    ...
    # ------------------------------------------------------------------
    def selectcard(self, candidates):
        """ Select card from candidates, return it """        
        
        # Trivial choice: Last card
...
if __name__ == "__main__":
    ...
    game = Crazy8s(title="Crazy 8s", players=Player.createlist(5))
    game.initialize()
